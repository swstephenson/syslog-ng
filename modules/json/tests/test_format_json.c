...
test_format_json(void)
{
  ...
  assert_template_format("$(format-json --leave-initial-dot .program.@name=${PROGRAM})", "{\".program\":{\"@name\":\"syslog-ng\"}}");
  assert_template_format("$(format-json --leave-initial-dot .program.@name=${PROGRAM} .program.foo .program.bar)", "{\".program\":{\"@name\":\"syslog-ng\"}}");
}
